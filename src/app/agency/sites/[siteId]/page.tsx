...
import { sites, incidents, guards, patrollingOfficers } from '@/lib/data';
...
export default function AgencySiteReportPage() {
  ...
  const supervisor = patrollingOfficers.find(p => p.id === site.patrollingOfficerId);
          ...
          <div className="text-sm text-muted-foreground mt-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p>{supervisor ? supervisor.name : 'Unassigned'}</p>
              </div>
            </div>
             <div className="flex items-start gap-3">
